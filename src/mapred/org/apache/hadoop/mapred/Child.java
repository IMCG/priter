      ...
      while (true) {
        ...
        if (myTask.shouldDie()) {
          ...
          if (myTask.getTask() == null) {
        	  /*
        	  //start pkvBuffer
        	  if(!umbilical.getPriorityBuffer().getServeJobName().equals(myTask.getTask().conf.getJobName())){
        		  umbilical.getPriorityBuffer(myTask.getTask().conf.getJobName(),
        				  myTask.getTask().conf.getOutputKeyClass(), 
        				  myTask.getTask().conf.getOutputValueClass());
        	  }
        	  */
