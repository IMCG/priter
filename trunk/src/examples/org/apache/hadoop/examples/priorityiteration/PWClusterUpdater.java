...
public class PWClusterUpdater extends MapReduceBase implements
		Updater<IntWritable, DoubleWritable, ClusterWritable> {
	...
	public void initStateTable(
			OutputPKVBuffer<IntWritable, DoubleWritable, ClusterWritable> stateTable) {
		//init it
		/*
		List<Integer> keys = new ArrayList<Integer>(nodes.keySet());
	...
	@Override
	public DoubleWritable decidePriority(IntWritable key, ClusterWritable arg0) {
			double value = arg0.getAddvalue();
				return new DoubleWritable(value);
	}

	@Override
	public DoubleWritable decideTopK(IntWritable key, ClusterWritable arg0) {
			double value = arg0.getAddvalue();
				return new DoubleWritable(value);
	}
	...
	public void updateState(IntWritable key, Iterator<ClusterWritable> values,
			OutputPKVBuffer<IntWritable, DoubleWritable, ClusterWritable> buffer, Reporter report)
			throws IOException {
